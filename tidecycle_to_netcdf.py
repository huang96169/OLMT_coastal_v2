...
sal_data = pandas.read_csv('/home/whf/E3SM/OLMT_coastal_v2/PLM_saldata.csv')
...
time=xarray.Variable(dims='time',data=arange(8760),attrs={'units':'hours'})
...
d.to_netcdf('./tidesPLM_2019_gapfill.nc')
